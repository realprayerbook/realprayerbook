    ...
    <header className="fixed top-0 left-0 right-0 z-50 px-6 py-6 transition-all duration-300">
      <div className="max-w-7xl mx-auto flex justify-between items-center relative z-50">
        ...
        <nav className="hidden lg:flex items-center gap-12">
           ...
           <button 
             onClick={onCtaClick}
             className="px-8 py-3 bg-brand-gold text-brand-purple font-black uppercase tracking-[0.2em] text-xs rounded-full hover:bg-white hover:text-brand-obsidian transition-colors shadow-[0_0_30px_rgba(212,175,55,0.3)] ml-4"
           >
             Claim Your Copy
           </button>
        </nav>
